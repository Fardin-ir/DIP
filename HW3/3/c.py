...
def hybrid_images(img1,img2,d1, d2):
    ...
    filtered_img2 = (img2 - img_idft(img2_dft * filter, False))
...
if __name__ == "__main__":
    ...
    plt.show()
    _,f_hybrid_image = img_dft(hybrid_image,False)
    plt.figure()
    plt.imshow(f_hybrid_image, cmap="gray")
    plt.title("Hybrid Image Image spectrum")
    plt.show()
